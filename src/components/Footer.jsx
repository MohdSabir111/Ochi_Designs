    ...
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 ">
      <div className="w-1/2 h-full flex flex-col justify-between  ">
        <div className="heading font-semibold">
          <h1 className="text-7xl uppercase -mb-4 ">Eye</h1>
          <h1 className="text-7xl uppercase -mb-4 ">Openinig</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="heading font-semibold">
        <h1 className="text-5xl uppercase  ">Presentations</h1>
        <div className="iconsDetails font-3xl">
          {["Facebook","instagram","Youtube","LinkdIn"].map((item, index)=>{
          return <a className="block my-14" key={index} href={`#${item}`}>{item}</a>
        })}
        </div>
